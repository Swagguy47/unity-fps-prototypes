...
public class NormalConvert : EditorWindow
{
    ...
    [MenuItem("Snowstorm Tools/Normal Map Converter")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow(typeof(NormalConvert));
    ...
    public void OnGUI()
    {
        ...
        //UI
        GUILayout.Space(75f);
        GUILayout.Label("Converts normal maps to be global");
        GUILayout.Space(10f);
        ...
        {
            InputNormal = ShowTexGUI("Input Normal Map:", InputNormal);
        }
    ...
    private Color[] ColorArray() //Where the magic happens, fips around the color channels
    {
        ...
        for (int j = 0; j < cl.Length; j++)
        {
            ...
            if (InputNormal != null)
                ...
                cl[j].g = 1;
            if (InputNormal != null)
                cl[j].b = 1 - InputNormal.GetPixel(j % width, j / width).a;
            else
                cl[j].b = 1;
            if (1 == 1)
            {
